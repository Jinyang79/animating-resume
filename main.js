let resume = `# 瑾阳
173****8861 | jinyang79@foxmail.com | 上海
...
- 熟悉 ES6 基本语法、解构赋值、常用的数据结构、promise 的含义和用法、async 函数、class 类以及模块化开发，在项目中熟练运用以及良好的编程风格。
- 掌握前后台的数据交互，熟悉原生 ajax，在项目中使用 $ajax 和 axios 请求数据，并对请求数据进行处理，了解 RESTful 风格的 api。
